...
In order to support loading of multiple wallets in pownodes-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is pownodes.cpp.
...
Changes to pownodes.cpp
----------------------
pownodes.cpp is the entry point into pownodes-qt, and as such, will require some minor modifications to provide hooks for
