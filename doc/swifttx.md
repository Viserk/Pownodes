...
This mechanism has been integrated into Bitcore-Node-Pownodes which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/Pownodes-Project/insight-api-pownodes#web-socket-api](https://github.com/Pownodes-Project/insight-api-pownodes#web-socket-api) 
* API: [https://github.com/Pownodes-Project/insight-api-pownodes#swifttx-transactions](https://github.com/Pownodes-Project/insight-api-pownodes#swifttx-transactions) 
...
By default, the Pownodes Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Pownodes Core daemon:
