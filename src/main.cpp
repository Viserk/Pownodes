...
#if defined(NDEBUG)
#error "Pownodes cannot be compiled without assertions."
#endif
...
int64_t GetBlockValue(int nHeight)
{
    ...
    if (nHeight == 0) {
        ...
        nSubsidy = 20 * COIN;
    }   else if (nHeight <= 25800 && nHeight > 8600) {
        nSubsidy = 100 * COIN;
    }   else if (nHeight <= 51600 && nHeight > 25800) {
        nSubsidy = 90 * COIN;
    }   else if (nHeight <= 86000 && nHeight > 51600) {
        nSubsidy = 80 * COIN;
    }   else if (nHeight <= 129000 && nHeight > 86000) {
        nSubsidy = 60 * COIN;
    }   else if (nHeight <= 180000 && nHeight > 129000) {
        nSubsidy = 40 * COIN;
    }   else if (nHeight <= 249400 && nHeight > 180000) {
        nSubsidy = 30 * COIN;
...
{
    RenameThread("pownodes-scriptch");
