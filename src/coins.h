...
/** 
    ...
    ****Note - for Pownodes we added fCoinStake to the 2nd bit. Keep in mind when reading the following and adjust as needed.
...
public:
    ...
    /** 
     * Amount of pownodes coming in to a transaction
