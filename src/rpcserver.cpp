...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Pownodes server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Pownodes server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Pownodes features */
        {"pownodes", "masternode", &masternode, true, true, false},
        {"pownodes", "listmasternodes", &listmasternodes, true, true, false},
        {"pownodes", "getmasternodecount", &getmasternodecount, true, true, false},
        {"pownodes", "masternodeconnect", &masternodeconnect, true, true, false},
        {"pownodes", "masternodecurrent", &masternodecurrent, true, true, false},
        {"pownodes", "masternodedebug", &masternodedebug, true, true, false},
        {"pownodes", "startmasternode", &startmasternode, true, true, false},
        {"pownodes", "createmasternodekey", &createmasternodekey, true, true, false},
        {"pownodes", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"pownodes", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"pownodes", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"pownodes", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"pownodes", "getmasternodescores", &getmasternodescores, true, true, false},
        {"pownodes", "mnbudget", &mnbudget, true, true, false},
        {"pownodes", "preparebudget", &preparebudget, true, true, false},
        {"pownodes", "submitbudget", &submitbudget, true, true, false},
        {"pownodes", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"pownodes", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"pownodes", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"pownodes", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"pownodes", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"pownodes", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"pownodes", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"pownodes", "checkbudgets", &checkbudgets, true, true, false},
        {"pownodes", "mnsync", &mnsync, true, true, false},
        {"pownodes", "spork", &spork, true, true, false},
        {"pownodes", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"pownodes", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use pownodesd, or the -server option to pownodes-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> pownodes-cli " + methodname + " " + args + "\n";
}
