...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Pownodes Core pownodes-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  pownodes-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pownodes transaction") + "\n" +
                               "  pownodes-tx [options] -create [commands]   " + _("Create hex-encoded pownodes transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded pownodes transaction
