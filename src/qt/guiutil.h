...
/** Utility functions used by the Pownodes Qt UI.
 */
namespace GUIUtil
{
...
// Render Pownodes addresses in monospace font
...
// Parse "pownodes:" URI into recipient object, return true on successful parsing
