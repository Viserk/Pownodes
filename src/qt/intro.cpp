...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Pownodes Core"),
     ...
     * override -datadir in the pownodes.conf file in the default data directory
     * (to be consistent with pownodesd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
