...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Pownodes Core");
    QString versionText = QString(tr("Version v1.1-MAIN")).arg(QString::fromStdString(FormatFullVersion()));
	...
	QString copyrightTextBecn = QChar(0xA9) + QString(tr(" 2018 The Pownodes Core developers"));
