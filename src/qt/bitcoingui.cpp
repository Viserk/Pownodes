                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Pownodes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Pownodes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and pownodes: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Pownodes Core"), this);
    aboutAction->setStatusTip(tr("Show information about Pownodes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Pownodes"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Pownodes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Pownodes addresses"));
    ...
    openAction->setStatusTip(tr("Open a Pownodes: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Pownodes Core help message to get a list with possible Pownodes command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Pownodes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Pownodes network", "", count));
}
...
{
    QString strTitle = tr("Pownodes Core"); // default title
